...
export async function GET(req: NextRequest) {
  ...
  let nextUrl: string | null = `${OCTOPUS_BASE}/gas-meter-points/${mprn}/meters/${serial}/consumption/?page_size=10000&order_by=period`;
  ...
  try {
    ...
    return NextResponse.json({ error: "Failed to fetch gas consumption" }, { status: 500 });
  }
}
